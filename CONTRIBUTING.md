# Contributing to Famick Home Management
...
2. Install PostgreSQL 16+ (or use Docker)
...
4. Start the development database:
   ```bash
   docker compose -f homemanagement/docker/docker-compose.dev.yml up -d
   ```
5. Build and run:
   ```bash
   dotnet build famick-self-hosted.sln
